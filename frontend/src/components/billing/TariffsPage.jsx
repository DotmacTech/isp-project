...
const TARIFF_TYPES = {
  internet: { key: 'internet', title: 'Internet Tariffs', endpoint: '/api/v1/internet-tariffs/', form: InternetTariffForm, initialValues: {} },
  voice: { key: 'voice', title: 'Voice Tariffs', endpoint: '/api/v1/voice-tariffs/', form: VoiceTariffForm, initialValues: { type: 'voip' } },
  recurring: { key: 'recurring', title: 'Recurring Tariffs', endpoint: '/api/v1/recurring-tariffs/', form: RecurringTariffForm, initialValues: {} },
  bundle: { key: 'bundle', title: 'Bundle Tariffs', endpoint: '/api/v1/bundle-tariffs/', form: BundleTariffForm, initialValues: {} },
  onetime: { key: 'onetime', title: 'One-Time Tariffs', endpoint: '/api/v1/one-time-tariffs/', form: OneTimeTariffForm, initialValues: { enabled: true } },
};
  ...
  return (
    <div>
      ...
      <Tabs defaultActiveKey="internet">
        {Object.values(TARIFF_CONFIG).map(config => (
          <Tabs.TabPane tab={config.title} key={config.key}>
