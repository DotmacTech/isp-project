...
function MonitoringDevicesPage() {
  ...
  return (
    <div>
      ...
      <Modal title={editingDevice ? 'Edit Monitoring Device' : 'Add Monitoring Device'} open={isModalVisible} onCancel={handleModalCancel} footer={null} destroyOnClose width={900}>
