...
const SERVICE_TYPES = {
    internet: { key: 'internet', title: 'Internet Services', endpoint: '/v1/internet-services/', form: InternetServiceForm, tariffEndpoint: '/v1/internet-tariffs/' },
    voice: { key: 'voice', title: 'Voice Services', endpoint: '/v1/voice-services/', form: VoiceServiceForm, tariffEndpoint: '/v1/voice-tariffs/' },
    recurring: { key: 'recurring', title: 'Recurring Services', endpoint: '/v1/recurring-services/', form: RecurringServiceForm, tariffEndpoint: '/v1/recurring-tariffs/' },
    bundle: { key: 'bundle', title: 'Bundle Services', endpoint: '/v1/bundle-services/', form: BundleServiceForm, tariffEndpoint: '/v1/bundle-tariffs/' },
};
