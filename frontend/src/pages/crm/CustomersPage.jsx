...
function CustomersPage() {
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space>
          ...
          <Link to={`/dashboard/customers/${record.id}/sessions`}>
  ...
  return (
    <div>
      ...
      <Modal title={editingService ? 'Edit Service' : 'Add Service'} open={isServiceModalVisible} onCancel={handleServiceModalCancel} footer={null} destroyOnHidden>
